%% Stereo HSV-Based Live Tracker for Multiple Colors with HSV + Timestamp Trajectory Saving
clc; close all; clear;
...
positions3D = cell(numColors,1);  % each cell stores Nx3 matrix
frameIdx = 0;
...
while true
    ...
    % --- Visualization (only if figure exists) ---
    if ishandle(hFig)
